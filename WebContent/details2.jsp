 ...
 <%
	try
	{
	  ...
	  while(rs.next())
	  {
		     ...
		     String check="select * from agreement where pid="+pid;
  ...
  <% 
    ...
    {
    	%>
    	<a href="agreement_sucess.jsp?aid=<%=rs1.getInt("aid") %>"> <button class="btn btn-primary" type="submit" >Show Agreement</button></a>
    	<% }
    else
    {
    	%>
  	 <a href="agree_form.html"> <button class="btn btn-primary" type="submit" >Make Agreement</button></a>
	<% 
	}
  %>
    </div>
