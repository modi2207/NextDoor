...
<body>
	...
	<div id="wrapper">
         <div class="navbar navbar-inverse navbar-fixed-top" id="id1">
        ...
        <!-- /. NAV TOP  -->
        <nav class="navbar-default navbar-side" role="navigation" id="id2">
	...
	/*	  String own = "select * from userTable where emil = '" + oid + "'";
		  ...
		  <h2 style="position:relative; left:200px; Text-decoration:underline;"> Rent Agreement</h2>
		  
		  <div>
			<img id="imgsrc" style=" width: 340px;height: 146px; margin-left: 160px; border-radius: 10px;" src="images/agree.jpg">
		</div>
		<br>
